...
<head>
    ...
    <title>UI Card | Bootstrap Simple Admin Templatep</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <h5 class="card-header">Card Action Button</h5>
                                        <div class="card-body">
                                            <p class="card-text">This is some text within a card body and card footer...</p>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card mb-3">
                                <img class="card-img-top" src="assets/img/image-wide.svg" alt="Card image cap">
                                <div class="card-body">
